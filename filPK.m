...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function  [xAInst, gainUlt]= filPK(x, fs, gainAux, lpFilt)
...
%===================================%
ATT = 50e-6; % Attack time [ms]
RLS = 50e-6; % Release time [ms]
...
env = filter(lpFilt,x); %aplico el filtro de tipo FIR FPB de fc = 80Hz. hay que tener en cuenta que este tiene que ser un filtro IIR porque sino te distorsiona la señal
